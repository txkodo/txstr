...
data modify storage txstr loop.string_concat set from block 29999985 0 43381 LastOutput
data modify storage txstr loop.split_concat set from block 29999984 0 43381 LastOutput
...
# ソート済み
data modify block 29999985 1 43381 Command set value 'tag d718fdc0-dc29-44f3-9409-0012bde34e23 list'
# 未ソート(未完)
data modify block 29999985 0 43381 Command set value 'tag f2f670c8-260b-4689-ae50-7f8de19a38de list'
